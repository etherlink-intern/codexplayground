...
| XLSX | CoreXLSX for workbook parsing | Recognized, returns `unsupportedFormat`. |

See [Docs/NativeConverterBackends.md](Docs/NativeConverterBackends.md) for the implementation plan, integration effort, source links, and acknowledgement policy.
